...
class PostCard extends StatelessWidget {
  ...
  // List of unique person images for user profiles
  ...
  // List of images for user posts
  final List<String> imageUrlsPosts = [
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildContent(), // Call the new content method
        ],
      ),
    );
  }
  ...
  Widget _buildContent() {
    // Assuming the post has an image index or a specific image URL
    // Here, we can just randomly select an image for demonstration
    String postImageUrl = imageUrlsPosts[0]; // Replace with logic to select the appropriate post image
        ...
        children: [
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                postImageUrl, // Use the same image for the post
